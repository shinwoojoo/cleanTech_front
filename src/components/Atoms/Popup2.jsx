...
const Popup2 = ({onClose, userRole, username}) => {
    ...
    const handleChange = (event) => {
        setSelectedValue(event.target.selectedOptions[0].text);
    }
    ...
    return (
        <Background>
            <PopupBox>
                ...
                <SubmitImage username={username} userRole={userRole} selectedValue={selectedValue || "1 : 본관 1층 복도 전체(이사장실~ 끝) + 본관 엘리베이터"}/>
            </PopupBox>
        </Background>
    );
};
